...
from msagent.envs.fighting.env.gym_ai_display import GymAIDisplay
...
class FightingiceEnv_TwoPlayer(gym.Env):
    ...
    def __init__(self, freq_restart_java=3, env_config=None, java_env_path=None, port=4242, auto_start_up=False, frameskip=False, display=False, p2_server = None):
