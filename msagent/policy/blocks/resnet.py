...
def _build_bottleneck_branch(inplanes, planes, ngroups, stride, expansion, groups):
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, ngroups, stride, downsample, cardinality):
...
class SEBottleneck(Bottleneck):
    ...
    def __init__(self, inplanes, planes, ngroups, stride=1, donwsample=None, cardinality=1):
        super(SEBottleneck, self).__init__(inplanes, planes, ngroups, stride, donwsample, cardinality)
...
class ResNet(nn.Module):
    def __init__(self, in_channels, base_planes, ngroups, block, layers, cardinality):
    ...
    def _make_layer(self, block, ngroups, planes, blocks, stride):
        downsample = None
